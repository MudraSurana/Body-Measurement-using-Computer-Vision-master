...
def measure_distance(segmented_image,segmented_arm_image,arm_spread_image,waist_image,image,metre_pixel_x,metre_pixel_y):
    ...
    if (71 <= perimeter <= 76):
        print("Size of jeans will be XS.")
    elif (76 < perimeter <= 81):
        print("Size of jeans will be S.")
    elif (81 < perimeter <= 86):
        print("Size of jeans will be M.")
    elif (86 < perimeter <= 91):
        print("Size of jeans will be L.")
    elif (91 < perimeter <= 96):
        print("Size of jeans will be XL.")
    elif (96 < perimeter <= 111):
        print("Size of jeans will be XXL.")
    elif (111 < perimeter <= 127):
        print("Size of jeans will be 3XL.")
    ...
    if ((dist+dist_ans)/2 <= 44):
        print("Size of Regular sized-shirt will be 38.")
    elif (44 < (dist+dist_ans)/2 <= 46):
        print("Size of Regular sized-shirt will be 39.")
    elif (46 < (dist+dist_ans)/2 <= 47):
        print("Size of Regular sized-shirt will be 40.")
    elif (47 < (dist+dist_ans)/2 <= 48):
        print("Size of Regular sized-shirt will be 41.")
    elif (48 < (dist+dist_ans)/2 <= 49):
        print("Size of Regular sized-shirt will be 42.")
    elif (49 < (dist+dist_ans)/2 <= 50):
        print("Size of Regular sized-shirt will be 43.")
    elif (50 < (dist+dist_ans)/2 <= 51):
        print("Size of Regular sized-shirt will be 44.")
    elif (51 < (dist+dist_ans)/2 <= 52):
        print("Size of Regular sized-shirt will be 45.")
    elif (52 < (dist+dist_ans)/2 <= 53):
        print("Size of Regular sized-shirt will be 46.")
    elif (53 < (dist+dist_ans)/2 <= 55):
        print("Size of Regular sized-shirt will be 47.")
    elif (55 < (dist+dist_ans)/2 <= 56):
        print("Size of Regular sized-shirt will be 48.")
